...
//System.setIn(new FileInputStream("res/input.txt"));
		...
		for (int test_case = 1; test_case <= T; test_case++) {
			...
			ArrayList<String> cardOne = new ArrayList<String>();
			ArrayList<String> cardTwo = new ArrayList<String>();
			...
			for (int i = 0; i < n; i++) {
				if (i % 2 == 0) {
					answerList.add(cardOne.get(i / 2));
				} else {
					answerList.add(cardTwo.get(i / 2));
				}
			}
